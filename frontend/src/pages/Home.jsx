...
const features = [
  { icon: '🤖', title: 'XGBoost + Elo Model', desc: 'Trained on 45,000+ historical matches. Uses Elo ratings, recent form, head-to-head records, and tournament stage.' },
  { icon: '🎲', title: 'Monte Carlo Simulator', desc: 'Run 10,000 tournament simulations to calculate each team\'s real probability of winning the World Cup.' },
  { icon: '✨', title: 'AI Match Narratives', desc: 'GPT-4o-mini generates journalist-quality pre-match previews with key stats and matchup analysis.' },
  { icon: '🏟️', title: 'Live Bracket', desc: 'Every upcoming match with win probabilities. Updates in real time as tournament results come in.' },
]
      ...
      <div className="container">
        ...
        <div style={{ textAlign: 'center', padding: '4rem 1rem 3rem', maxWidth: 700, margin: '0 auto' }} className="fade-in">
          ...
          <p style={{ fontSize: '1.15rem', color: 'var(--text-secondary)', marginBottom: '2rem', lineHeight: 1.7 }}>
            AI-powered 2026 FIFA World Cup predictions — machine learning meets the beautiful game.
            Real probabilities, not gut feelings.
          </p>
        ...
        <div className="grid-2" style={{ marginBottom: '3rem' }}>
          {features.map(({ icon, title, desc }) => (
            <div key={title} className="glass-card fade-in" style={{ padding: '1.75rem', display: 'flex', gap: '1.25rem', alignItems: 'flex-start' }}>
        ...
        <div className="glass-card" style={{ padding: '2.5rem', textAlign: 'center', background: 'rgba(245,158,11,0.04)', borderColor: 'var(--border-gold)' }}>
          <h2 style={{ marginBottom: '0.75rem' }}>Ready to simulate the World Cup? 🏆</h2>
          <p style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem' }}>
            Run 10,000 tournament simulations and see which team your model picks.
          </p>
